...
export function WorkspacePage({ focusedSourceId }: WorkspacePageProps) {
  ...
  return (
    <div className="min-h-screen bg-[#f6f5f2] p-4 md:p-6">
      <div className="mx-auto flex max-w-[1600px] flex-col xl:h-[calc(100dvh-3rem)]">
        <section className="flex min-h-[calc(100vh-3rem)] flex-col rounded-[28px] border border-border/70 bg-background/95 p-5 xl:min-h-0 xl:flex-1 xl:overflow-hidden">
          ...
          <div className="mt-4 grid gap-4 xl:min-h-0 xl:flex-1 xl:grid-cols-[300px_minmax(0,1fr)_360px]">
            <SourcesPanel
